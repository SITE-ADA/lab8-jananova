...
public class CourseController {
    ...
    @GetMapping
    @Operation(summary = "Bütün kursları gətir", description = "Mövcud bütün kurslarn siyahısını qaytarır.")
    public ResponseEntity<List<CourseResponseDto>> getAllCourses() {
        return ResponseEntity.ok(courseService.getAllCourses());
    }

    @GetMapping("/{id}")
    @Operation(summary = "ID ilə kurs gətir", description = "Verilmiş ID-yə uyğun kursu qaytarır.")
    ...
    @PutMapping("/{id}")
    @Operation(summary = "Kursu yenilə", description = "Mövcud kursu ID ilə yeniləyir.")
    ...
    @Operation(summary = "Tələbəni kursa qeydiyyatdan keçir", description = "Əvvəlcə ilkin şərti yoxlayır, sonra qeydiyyatdan keçirir.")
    ...
    @Operation(summary = "Kursun tələbələrini gətir", description = "Kursun bütün tələbələrini qaytarır.")
